...
var waterfall = (_temp2 = _class = function (_BaseComponent) {
  ...
  function waterfall() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = waterfall.__proto__ || Object.getPrototypeOf(waterfall)).call.apply(_ref, [this].concat(args))), _this2), _this2.$usedState = ["tits", "leftData", "android", "heart", "hearts", "rightData", "datas", "types"], _this2.$$refs = [], _temp), _possibleConstructorReturn(_this2, _ret);
  }
  ...
  _createClass(waterfall, [{
    ...
    value: function dianzna(index) {
      ...
      var _this = this;
      _api2.default.post('api/product_recommend_like', {
        id: index
      }).then(function (res) {
        if (res.code === 20000) {
          _this.ajaxData();
    ...
    value: function ajaxData() {
      ...
      var left = [];
      var right = [];
      _api2.default.get('api/product_recommendations').then(function (res) {
        var resData = res.data; // 返回的数据
        console.warn(resData);
        resData.map(function (e, index) {
    ...
    value: function toLink(e) {
      ...
      _index2.default.navigateTo({
        url: "/pages/newStarsDetail/index?id=" + e.id + "&total=" + e.awesome_total + "&gid=" + e.gid + "&gid_pic=" + e.gid_pic
      });
    }
  }, {
    key: "_createData",
